...
<body>
    ...
    <div id="menu">
<ul id="nav" style="border-bottom-color: #CCCCCC; border-bottom-width: 1px;    border-bottom-style: solid;">
        <li style="width: 84px; height: 28px;"><a  href="#" class="selected">省份编辑</a></li>
        <li style="width: 84px; height: 28px;"><a href="#" class="">市名编辑</a></li>
            <li style="width: 84px; height: 28px;"><a href="#" class="">县名编辑</a></li>
                <li style="width: 84px; height: 28px;"><a href="#" class="">镇名编辑</a></li>
                    <li style="width: 84px; height: 28px;"><a href="#" class="">村名编辑</a></li>
   </ul>
<!--二级菜单-->
    <div id="menu_con">
...
<asp:Label ID="Label2" runat="server" Text='<%# this.GridView3.PageIndex * this.GridView3.PageSize + this.GridView3.Rows.Count + 1%>' /> 
      ...
      <asp:BoundField DataField="sm" HeaderText="县名" ReadOnly="True" />
