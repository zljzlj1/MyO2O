  ...
  <tr>
    <td width="182" valign="top"><div id="container">
      ...
      <div class="content">
        ...
        <ul class="MM">
                                      ...
                                      <li><a href="xgzdz.aspx" target="mainFrame">修改镇名</a></li>
                                        ...
                                        <li><a href="editconfig.aspx" target="mainFrame">修改基本信息</a></li>
      ...
      <div class="content">
        ...
        <ul class="MM">
             <li> <a href="addinfokeywords.aspx" target="mainFrame">添加管理员</a></li>
                                        <li><a href="editcode.aspx" target="mainFrame">修改管理员信息</a></li>
      ...
      <div class="content">
        ...
        <ul class="MM"> 
         <li><a href="adminclass.aspx" target="mainFrame">用户信息</a></li>
                                        <li><a href="addclass.aspx" target="mainFrame">审核文章</a></li>
                                         <li><a href="adminclass.aspx" target="mainFrame">已审核的文章信息</a></li>
                                            <li><a href="adminclass.aspx" target="mainFrame">订单支付状况</a></li>
      ...
      <div class="content">
        ...
        <ul class="MM">
                                         ...
                                         <li> <a href="addproduct.aspx" target="mainFrame">添加商家</a></li>
                                          <li> <a href="adminproduct.aspx?producttop=0" target="mainFrame">商家信息</a></li>
                                                 <li> <a href="adminproduct.aspx?producttop=1" target="mainFrame">订单核对</a></li>
       </ul>
      </div>
     ...
     <h1 class="type"><a href="javascript:void(0)">其他配置</a></h1>
      <div class="content">
        ...
        <ul class="MM">                                                          
                                        ...
                                        <li><a href="addadmin.aspx" target="mainFrame">添加管理</a></li>
                                        <li><a href="backup.aspx" target="mainFrame">备份网站</a></li>
