...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table cellspacing="0" cellpadding="0" width="100%"  class="tablexian" 
    border="0" style="height: 500px">
     ...
     <tr>
        ...
        ControlToValidate="TextBox2" Display="Dynamic" ErrorMessage="请输入密码,长度为1-6个字符" 
        ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        ControlToValidate="TextBox3" Display="Dynamic" ErrorMessage="请输入密码,长度为1-6个字符" 
        ForeColor="Red"></asp:RequiredFieldValidator>
